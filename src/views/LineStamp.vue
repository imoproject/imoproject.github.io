<template>
  <section>
    <div class="wrapper">
      ...
      <h2>LINEスタンプ</h2>
      <p>
        IMOPROJECTでは、LINEスタンプを販売しております。<br />
        おいもちゃんとお友達の猫ちゃんは、<br />
        IMOPROJECTオリジナルキャラクターです！<br />
        ほっこり芋ライフを、スタンプでも！ 可愛い仲間が、あなたのトークを<br />
        もっとホクホクにしてくれるはず…！ お買い求めはこちらから🎉<br />
        <br />
      </p>
    </div>
    <div class="wrapper">
      <a href="https://store.line.me/stickershop/product/24031211/ja"
        ><div class="line-wrapper">
          ...
          <p>
            のんびり屋の<br class="only-sp" />おいもちゃんと<br
              class="only-sp"
            />猫ちゃん
          </p>
        </div></a
